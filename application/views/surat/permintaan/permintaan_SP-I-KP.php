                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group <?php if(form_error('keperluan')) {echo 'text-danger';}?>">
                        ...
                        <textarea type="text" rows="5" name="keperluan" class="form-control <?php if(form_error('keperluan')) {echo 'is-invalid';}?>" id="spkpCosKeperluan" placeholder="Agar diperkenankan kegiatan Kerja Praktek/Magang Kurang Lebih Selama 2 Minggu (14 Hari) dan diberikannya Bimbingan serta meminta data mengenai Profil desa, data kependudukan, dan data opsional yang memungkinkan dalam pelaksanaan Kerja Praktek. " ><?= set_value('keperluan')?></textarea>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group <?php if(form_error('keperluan')) {echo 'text-danger';}?>">
                          ...
                          <textarea type="text" rows="5" name="keperluan" class="form-control <?php if(form_error('keperluan')) {echo 'is-invalid';}?>" id="spkpKeperluan" placeholder="Agar diperkenankan kegiatan Kerja Praktek/Magang Kurang Lebih Selama 2 Minggu (14 Hari) dan diberikannya Bimbingan serta meminta data mengenai Profil desa, data kependudukan, dan data opsional yang memungkinkan dalam pelaksanaan Kerja Praktek. "><?= set_value('keperluan');?></textarea>
                          <?= form_error('keperluan', '<small class="text-danger pl-3">', '</small>');?>
                        </div>
                        <!-- / Kepada Yth. Surat Di Ajukan -->
