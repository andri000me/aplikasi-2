                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group <?php if(form_error('keperluan')) {echo 'text-danger';}?>">
                        ...
                        <textarea type="text" rows="5" name="keperluan" class="form-control <?php if(form_error('keperluan')) {echo 'is-invalid';}?>" id="spkpCosKeperluan" placeholder="Agar diperkenankan kegiatan Penelitian dan meminta Data pada website instansi." ><?= set_value('keperluan')?></textarea>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group <?php if(form_error('keperluan')) {echo 'text-danger';}?>">
                          ...
                          <textarea type="text" rows="5" name="keperluan" class="form-control <?php if(form_error('keperluan')) {echo 'is-invalid';}?>" id="spkpKeperluan" placeholder="Agar diperkenankan kegiatan Penelitian dan meminta Data pada website instansi."><?= set_value('keperluan');?></textarea>
                          <?= form_error('keperluan', '<small class="text-danger pl-3">', '</small>');?>
                        </div>
                        <!-- / Kepada Yth. Surat Di Ajukan -->
                          ...
                          <div  class="col-md-6">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                ...
                                <div class="form-group">
                                  <label for="spkpKeperluan" class="col-form-label">Keperluan</label>
                                  <textarea type="text" rows="5" name="keperluan" class="form-control" id="spkpKeperluan" placeholder="Agar diperkenankan kegiatan Penelitian dan meminta Data pada website instansi." readonly><?= $onepmr->keperluan ;?></textarea>
                                  <?= form_error('keperluan', '<small class="text-danger pl-3">', '</small>');?>
                                </div>
                                <!-- / Keperluan Surat Di Ajukan -->
