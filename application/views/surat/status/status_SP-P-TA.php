                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <textarea type="text" rows="1" name="keperluan" class="form-control" id="spkpKeperluan" placeholder="Agar diperkenankan kegiatan Penelitian dan meminta Data pada website instansi." readonly><?= $onestatus->keperluan;?></textarea>
                      </div>
                      <!-- / Kepada Yth. Surat Di Ajukan -->
